 ...
 * AboutFragment.kt is part of LatentJam.
 *
 ...
 */
package io.github.nikitasud.latentjam.settings
...
import io.github.nikitasud.latentjam.databinding.FragmentAboutBinding
...
import io.github.nikitasud.latentjam.util.openInBrowser
import io.github.nikitasud.latentjam.util.startIntent
...
class AboutFragment : ViewBindingFragment<FragmentAboutBinding>() {
    ...
    override fun onBindingCreated(binding: FragmentAboutBinding, savedInstanceState: Bundle?) {
        ...
        binding.aboutFeedbackEmail.setOnClickListener {
            requireContext().sendEmail("feedback@latentjam.app")
        }
    ...
    private companion object {
        const val LINK_SOURCE = "https://github.com/latentjam/latentjam"
